...
from data.abaw_data import HumeDatasetEval, HumeDatasetTrain
...
class TrainingConfiguration:
    ...
    #                 'bert-base-uncased')  # 'facebook/wav2vec2-large-960h') # ('facebook/dinov2-small', 'hf-audio/wav2vec2-bert-CV16-en') or ('linear', 'linear')
    model: tuple = ('linear',
    ...
    seed = 1
    epochs: int = 30
    batch_size: int = 16  # real_batch_size = 2 * batch_size
    verbose: bool = True
