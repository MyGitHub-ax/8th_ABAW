...
def init_run():
    ...
    name= 'test_0002'
    img_path = join(root_dir, f'data/liuran/lr/debug/input/faces/{name}.jpg')
    ...
    outd = join(root_dir, f'data/liuran/lr/debug/input/faces-landmarks')
...
def run_split(ds_name: str, split: str, plot_landmarks: bool):
    ...
    store_draw_lnd_im = join(root_dir, f'data/liuran/lr/debug/out/landmarks/{ds_name}')
