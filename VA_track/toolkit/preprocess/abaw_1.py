...
def split_feature_by_length_ABAW(data_root, save_root,args):
    ...
    test_path='/data/emotion-data/abaw/PreProcessed/RJCMA/6th_ABAW_Annotations/VA/Test_Set'
    test_save_path='/data/emotion-data/abaw/PreProcessed/RJCMA/PreProcessed/Original/Split_Feature_Label/split_label/Test_Set'
...
def split_label_by_length_ABAW(data_root, save_root,args):
    data_root="/data/emotion-data/abaw/PreProcessed/RJCMA/6th_ABAW_Annotations/VA"
...
def normalize_dataset_format(data_root, save_root,args):
    # gain paths
    feature_path=os.path.join(data_root,'PreProcessed','Original','compacted_48')
    label_path = os.path.join(data_root,'PreProcessed','Original','new_labels')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature',type=str, default="bert-FRA")
    ...
    save_root = '/data/emotion-data/abaw/PreProcessed/RJCMA/PreProcessed/Original'
