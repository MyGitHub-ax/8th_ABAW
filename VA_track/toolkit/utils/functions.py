...
def func_video_to_face(vname):
    npy_path = os.path.join(config.PATH_TO_FACE[config.dataset], vname, vname + '.npy')
...
if __name__ == '__main__':
    func_split_audio_from_video_16k('/data/emotion-data/abaw/Videos/batch2/',"/data/emotion-data/abaw/PreProcessed/Original/Audios")